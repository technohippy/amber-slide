...
protocol: 'adding/removing',
fn: function (anObject,index){
var self=this;
return smalltalk.withContext(function($ctx1) { 
self.splice(index - 1, 0, anObject); return anObject;;
return self}, function($ctx1) {$ctx1.fill(self,"add:beforeIndex:",{anObject:anObject,index:index},globals.Array)})},
args: ["anObject", "index"],
source: "add: anObject beforeIndex: index\x0a\x09<self.splice(index - 1, 0, anObject); return anObject;>",
messageSends: [],
referencedClasses: []
}),
globals.Array);
